...
public class Literary_AlbumsAdapter extends RecyclerView.Adapter<Literary_AlbumsAdapter.MyViewHolder> {
    ...
    public Literary_AlbumsAdapter(Context mContext, List<Album> albumList) {
