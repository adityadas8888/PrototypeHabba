package com.example.aditya.prototypehabba.map.GridviewMenu.card4;
...
public class Gaming extends AppCompatActivity {
    ...
    private Gaming_AlbumsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Gaming_AlbumsAdapter(this, albumList);
    ...
    private void prepareAlbums() {
        ...
        a = new Album("CounterStrike 1.6", 8, covers[1]);
        albumList.add(a);

        a = new Album("Need for Speed: MW1", 11, covers[2]);
        albumList.add(a);

        a = new Album("FIFA-14", 12, covers[3]);
        albumList.add(a);

        a = new Album("Call of Duty MW4", 14, covers[4]);
        albumList.add(a);
