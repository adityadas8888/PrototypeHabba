...
public class Intracollege extends AppCompatActivity {

    private RecyclerView recyclerView;
    private Intracollege_AlbumsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Intracollege_AlbumsAdapter(this, albumList);
    ...
    private void prepareAlbums() {
        ...
        a = new Album("Lagori", 11, covers[2]);
        albumList.add(a);

        a = new Album("Slow Bike Race", 12, covers[3]);
        albumList.add(a);

        a = new Album("Rangoli", 14, covers[4]);
        albumList.add(a);

        a = new Album("Break the Matki", 1, covers[5]);
        albumList.add(a);

        a = new Album("Beg,Borrow,Steal", 11, covers[6]);
        albumList.add(a);

        a = new Album("Treasure-Hunt", 11, covers[7]);
        albumList.add(a);
