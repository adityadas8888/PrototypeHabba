...
public class Gaming_AlbumsAdapter extends RecyclerView.Adapter<Gaming_AlbumsAdapter.MyViewHolder> {
    ...
    public Gaming_AlbumsAdapter(Context mContext, List<Album> albumList) {
