package com.example.aditya.prototypehabba.map.GridviewMenu.card11;
...
public class Technical_AlbumsAdapter extends RecyclerView.Adapter<Technical_AlbumsAdapter.MyViewHolder> {
    ...
    public Technical_AlbumsAdapter(Context mContext, List<Album> albumList) {
