...
public class Management_AlbumsAdapter extends RecyclerView.Adapter<Management_AlbumsAdapter.MyViewHolder> {
    ...
    public Management_AlbumsAdapter(Context mContext, List<Album> albumList) {
