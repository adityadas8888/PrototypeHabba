package com.example.aditya.prototypehabba.map.GridviewMenu.card1;
...
public class Dance_AlbumsAdapter extends RecyclerView.Adapter<Dance_AlbumsAdapter.MyViewHolder> {
    ...
    public Dance_AlbumsAdapter(Context mContext, List<Album> albumList) {
