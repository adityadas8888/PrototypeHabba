...
public class Dramatics_AlbumsAdapter extends RecyclerView.Adapter<Dramatics_AlbumsAdapter.MyViewHolder> {
    ...
    public Dramatics_AlbumsAdapter(Context mContext, List<Album> albumList) {
