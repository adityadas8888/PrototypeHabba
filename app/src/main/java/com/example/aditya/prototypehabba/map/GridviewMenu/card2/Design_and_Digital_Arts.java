...
public class Design_and_Digital_Arts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new DAD_AlbumsAdapter(this, albumList);
    ...
    private void prepareAlbums() {
        ...
        a = new Album("Photo-Manipulation", 8, covers[1]);
        albumList.add(a);

        a = new Album("Short Film Making", 11, covers[2]);
        albumList.add(a);
